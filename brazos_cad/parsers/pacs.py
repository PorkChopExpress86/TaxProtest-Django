...
2025 certified export (see ``var/bcad_extracted/<year>/`` after running
...
headers a normal CSV would have. See ``brazos_cad/tests/test_parsers.py`` for
...
# analog of data.models.PropertyJurisdictionExemption (wide: one column per
