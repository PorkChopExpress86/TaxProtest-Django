...
Pipeline:
  ...
  4. Parse each fixed-width .TXT file (see brazos_cad/parsers/pacs.py for the
...
brazos_cad/models.py and brazos_cad/parsers/pacs.py docstrings for exactly
...
APPRAISAL_ENTITY_INFO.TXT is ingested into data.models.PropertyJurisdictionExemption
(county="brazos") -- NOT a brazos_cad model. That table is shared with Harris
(see wayfinder ticket #9): data.tax_impact.calculate_tax_impact() is reused
