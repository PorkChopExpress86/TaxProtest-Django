...
# AssessmentHistory, TaxUnitRate, and PropertyJurisdictionExemption moved to
# counties/common/tax_models.py -- they're shared, county-scoped tables, not
# Harris-owned (wayfinder ticket #9). Their Meta.app_label is still pinned to
# "data" (this app's label), so nothing about the tables, migration history,
# or content types changed; only where the Python class definitions live.
